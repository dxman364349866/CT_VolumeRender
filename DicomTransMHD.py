...
# 路径和列表声明
PathDicom = "C:/Users/Tech_19AREA/Desktop/MidecalTest/Test_CT5/"  # 与python文件同一个目录下的文件夹,存储dicom文件
SaveRawDicom = "C:/Users/Tech_19AREA/Desktop/MidecalTest/TransToMhd2/"  # 与python文件同一个目录下的文件夹,用来存储mhd文件和raw文件
lstFilesDCM = []
